...
import com.myproject.dao.MiaoshaUserDao;
import com.myproject.domain.MiaoshaUser;
import com.myproject.exception.GlobalException;
import com.myproject.redis.MiaoshaUserKey;
import com.myproject.redis.RedisService;
import com.myproject.result.CodeMsg;
import com.myproject.util.MD5Util;
import com.myproject.util.UUIDUtil;
...
public class MiaoshaUserService {
    ...
    public boolean updatePassword(String token, long id, String formPassword) {
        ...
        redisService.set(MiaoshaUserKey.token, token, user);//修改token
        return true;
    }
